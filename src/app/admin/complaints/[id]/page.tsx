          ...
          <div className="relative bg-white rounded-[2.5rem] w-full max-w-lg p-10 shadow-2xl my-auto h-fit animate-in zoom-in-95 duration-300" onClick={(e) => e.stopPropagation()}>
             ...
             <div className="space-y-6">
                ...
                <div className="flex gap-4 pt-4">
                   <button onClick={() => setShowAssignModal(false)} className="flex-1 py-4 bg-slate-100 text-slate-600 font-black rounded-2xl hover:bg-slate-200 transition-all uppercase text-[10px] tracking-widest">ยกเลิก</button>
                   <button 
                     onClick={() => {
                     ...
                     className="flex-1 py-4 bg-indigo-600 text-white font-black rounded-2xl hover:bg-indigo-700 transition-all uppercase text-[10px] tracking-widest disabled:opacity-50 shadow-lg shadow-indigo-600/20"
                   >
                     ยืนยันและมอบหมาย
                   </button>
                </div>
